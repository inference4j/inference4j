 ...
 * @see MiniLMReranker
 */
public interface CrossEncoderModel extends AutoCloseable {
    ...
    /**
     * Scores a query against multiple documents.
     *
     * @param query     the query text
     * @param documents the list of documents to score
     * @return relevance scores in the same order as the input documents
     */
