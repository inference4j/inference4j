...
class SmolLM2TextGeneratorModelTest {

    @Test
    void generate_producesNonEmptyText() {
        try (var gen = SmolLM2TextGenerator.builder().maxNewTokens(20).build()) {
    ...
    void generate_respectsMaxNewTokens() {
        try (var gen = SmolLM2TextGenerator.builder().maxNewTokens(5).build()) {
    ...
    @Test
    void generate_chatTemplateAppliedByDefault() {
        try (var gen = SmolLM2TextGenerator.builder().maxNewTokens(20).build()) {
