...
class SileroVadDetectorTest {
    ...
    void extractSegments_singleSpeechSegment() throws Exception {
        SileroVadDetector vad = createTestVad();
     ...
     */
    private SileroVadDetector createTestVad() throws Exception {
        java.lang.reflect.Constructor<SileroVadDetector> constructor =
                SileroVadDetector.class.getDeclaredConstructor(
     ...
     */
    private List<VoiceSegment> invokeExtractSegments(SileroVadDetector vad, float[] probabilities, int totalSamples)
            throws Exception {
        Method method = SileroVadDetector.class.getDeclaredMethod("extractSegments", float[].class, int.class);
